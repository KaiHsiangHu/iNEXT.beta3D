...
Des <- c("data","(a) For datatype = 'abundance', species abundance data for a single dataset can be input as a matrix/data.frame (species-by-assemblage); data for multiple datasets can be input as a list of matrices/data.frames, with each matrix representing a species-by-assemblage abundance matrix for one of the datasets.
...
"diversity","selection of diversity type: diversity = 'TD' = <font color=#FF6781>Taxonomic diversity</font>, diversity = 'PD' = <font color=#FF6781>Phylogenetic diversity</font>, and diversity = 'FD' = <font color=#FF6781>Functional diversity</font>.",
